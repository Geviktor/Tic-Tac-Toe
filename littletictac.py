...
# If x's and o's are crosswise or straight, game done.
...
#If game is draw return True, else return False
...
#check board straight for comp play
...
#check board cross for comp play
...
#Main function for player. control rows, colms, fix game and plays it.
